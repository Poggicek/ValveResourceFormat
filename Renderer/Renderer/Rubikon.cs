...
public class Rubikon
{
    ...
    private static void AABBTraceTriangle13AxisSat(AABBTraceContext trace, Vector3 v0, Vector3 v1, Vector3 v2, ref TraceResult closestHit)
    {
        ...
        if (trace.DetectStartSolid && enter < 0 && exit >= 0)
        {
            ...
            {
                StartSolid = true,
                ContactPoint = trace.ComputeContactPoint ? MathUtils.ClosestPointOnTriangle(trace.Origin, v0, v1, v2) : trace.Origin,
            };
            return;
        }
        ...
        if (hitDistance < closestHit.Distance)
        {
            ...
            {
                ContactPoint = trace.ComputeContactPoint ? MathUtils.ClosestPointOnTriangle(hitPoint, v0, v1, v2) : hitPoint,
            };
        }
    }
